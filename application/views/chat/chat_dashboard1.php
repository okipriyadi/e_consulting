...
<div class="row" id="container">
  <div class="col-md-12">
    <h1>
        Selamat datang <?= $this->user->name ?><br>
    </h1>
    <h3 style="float:left">
       Berikut data riwayat chatting anda :
    </h3>
    <a href="#" class="btn btn-info" style="float:right" data-toggle="modal" data-target="#myModal">Mulai Chatting</a>
    <!-- Modal -->
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header" style="background:#007bff; ">
            <h4 class="modal-title" style="color:white">Chatting Konsultasi</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>

          </div>
          <form  action="<?=base_url()?>index.php/chat/tambah_judul" method="POST">
              <div class="modal-body biru-langit" style="">
                  <div class="form-group ">
                    <label ><b>Judul Konsultasi:</b></label> &nbsp;&nbsp;
                    <input type="text" class="form-control" name="judul_konsultasi">
                  </div>
                  <div class="form-group ">
                    <label ><b>Jenis Konsultasi:</b></label> &nbsp;&nbsp;
                    <input type="text" list="jenis_konsultasi" / name="jenis_konsultasi">
                    <datalist id="jenis_konsultasi">
                      <option>LHKASN</option>
                      <option>WBS</option>
    ...
    <!-- ------------------------------------ modal end ---------------------------- -->
    <div class="row" style="clear:both; padding-left: 10px; padding-right:10px">
      <style>
        .box_riwayat{
      ...
      <div class="col-md-3 box_riwayat">
        <div class="padding-riwayat">
          <h6 class="judul-riwayat">Chat <span class="float-right">31 Agustus 2019</span></h6>
          ...
          <div class="col-md-12" style="text-align:center; background:black; border-radius:0px 0px 8px 8px">
            <button class="btn btn-secondary" style=" ;">Lihat Riwayat</button>
          </div>
...
<script type="text/x-template" id="msg-template" style="display: none">
    <tbody>
        <tr class="msg-wgt-message-list-header">
            <td rowspan="2"><img src="<?= base_url('assets/template/images/amsori.jpg') ?>"></td>
            <td class="name"></td>
            <td class="time"></td>
        </tr>
