<head>
  <title>E-Consulting Inspektorat</title>
  <link rel="icon" href="<?= base_url()?>assets/template/images/e_consulting.ico">
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">


  <link href="<?= base_url()?>assets/template/css/font_family.css" rel="stylesheet">
  <link href="<?= base_url()?>assets/template/css/font-family-main.css" rel="stylesheet">
